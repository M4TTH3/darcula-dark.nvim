...
M.configure_highlights = function(color)
  ...
  if M.config.opt.integrations.snacks then
    ...
    hi(0, "SnacksTerminalBorder", { bg = color.very_dark_gray, fg = color.dark_charcoal_gray })
    ...
    hi(0, "SnacksInputBorder", { bg = color.dark_grey, fg = color.dark_grey })
    ...
    hi(0, "SnacksLayoutBorder", { bg = color.dark, fg = color.dark_grey })
  ...
  hi(0, "FloatBorder", { bg = color.very_dark_gray, fg = color.dark_charcoal_gray })
  ...
  hi(0, "StatusLine", { bg = color.background, fg = color.very_light_gray })
  hi(0, "StatusLineNC", { bg = color.background, fg = color.grey })
