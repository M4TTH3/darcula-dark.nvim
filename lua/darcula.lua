...
M.configure_highlights = function(color)
  ...
  hi(0, "Character", { fg = color.steel_cyan })
  ...
  hi(0, "CursorColumn", { bg = color.cursor_row, ctermbg = 242 })
  hi(0, "CursorLine", { bg = color.cursor_row })
  hi(0, "CursorLineNr", { bg = color.cursor_row, bold = true, ctermfg = 11, fg = color.silver_gray })
  ...
  if M.config.opt.integrations.snacks then
    hi(0, "SnacksNormal", { bg = color.very_dark_gray, fg = color.grey })
    hi(0, "SnacksNormalNC", { bg = color.very_dark_gray, fg = color.grey })
    hi(0, "SnacksBackdrop", { bg = "#1a1a1a" })
    hi(0, "SnacksTerminalNormal", { bg = color.very_dark_gray, fg = color.grey })
    hi(0, "SnacksTerminalBorder", { bg = color.very_dark_gray, fg = color.comment })
    ...
    hi(0, "SnacksWinBar", { fg = color.very_light_gray, bold = true })
    hi(0, "SnacksWinBarNC", { fg = color.silver_gray })
    -- Picker
    ...
    hi(0, "SnacksPickerInputBorder", { bg = color.dark_charcoal_gray, fg = color.comment })
    ...
    hi(0, "SnacksInputNormal", { bg = color.dark_grey, fg = color.grey })
    hi(0, "SnacksInputBorder", { bg = color.dark_grey, fg = color.comment })
    hi(0, "SnacksInputTitle", { bg = color.dark_grey, fg = color.golden_yellow, bold = true })
    hi(0, "SnacksLayoutTitle", { bg = color.dark_grey, fg = color.golden_yellow, bold = true })
    hi(0, "SnacksLayoutBorder", { bg = color.dark, fg = color.comment })
    hi(0, "SnacksLayoutNormal", { bg = color.dark, fg = color.grey })
    hi(0, "SnacksLayoutBox", { bg = color.dark })
    -- Indent
  ...
  hi(0, "FloatBorder", { bg = color.very_dark_gray, fg = color.comment })
  ...
  hi(0, "Function", { fg = color.warm_yellow })
  ...
  hi(0, "LineNr", { ctermfg = 11, fg = color.line_number })
  ...
  hi(0, "Macro", { fg = color.burnt_orange })
  ...
  hi(0, "NonText", { bold = true, ctermfg = 12, fg = color.comment })
  hi(0, "MsgArea", { fg = color.grey })
  hi(0, "Normal", { bg = color.dark, fg = color.grey })
  hi(0, "NormalFloat", { bg = color.very_dark_gray, fg = color.grey })
  ...
  hi(0, "PreProc", { ctermfg = 81, fg = color.copper_brown })
  ...
  hi(0, "SignColumn", { ctermbg = 242, ctermfg = 14, fg = color.line_number })
  ...
  hi(0, "StatusLine", { bg = color.dark_grey, fg = color.very_light_gray })
  hi(0, "StatusLineNC", { bg = color.dark_grey, fg = color.silver_gray })
  ...
  hi(0, "TSAttribute", { fg = color.annotation_yellow })
  hi(0, "TSBoolean", { fg = color.burnt_orange })
  hi(0, "TSCharacter", { fg = color.steel_cyan })
  ...
  hi(0, "TSConstMacro", { fg = color.burnt_orange })
  ...
  hi(0, "TSPunctDelimiter", { fg = color.grey })
  ...
  hi(0, "TabLine", { bg = color.background, ctermbg = 242, ctermfg = 15, fg = color.silver_gray })
  hi(0, "TabLineFill", { bg = color.background, fg = color.silver_gray })
  ...
  if M.config.opt.integrations.noice then
    ...
    hi(0, "NoiceCmdlinePopupBorder", { bg = color.dark_charcoal_gray, fg = color.comment })
    ...
    hi(0, "NoiceConfirmBorder", { bg = color.dark_charcoal_gray, fg = color.comment })
    hi(0, "NoicePopup", { bg = color.dark_charcoal_gray })
    hi(0, "NoicePopupBorder", { bg = color.dark_charcoal_gray, fg = color.comment })
  ...
  if M.config.opt.integrations.blink_cmp then
    ...
    hi(0, "BlinkCmpMenuBorder", { bg = color.charcoal_gray, fg = color.comment })
    ...
    hi(0, "BlinkCmpDocBorder", { bg = color.dark_charcoal_gray, fg = color.comment })
    hi(0, "BlinkCmpDocCursorLine", { bg = color.dark_grey })
    hi(0, "BlinkCmpSignatureHelp", { bg = color.dark_charcoal_gray, fg = color.grey })
    hi(0, "BlinkCmpSignatureHelpBorder", { bg = color.dark_charcoal_gray, fg = color.comment })
  end
  ...
  hi(0, "Type", { ctermfg = 121, fg = color.soft_cyan })
  hi(0, "Typedef", { fg = color.soft_cyan })
  ...
  hi(0, "VertSplit", { fg = color.separator })
  hi(0, "WinSeparator", { fg = color.separator })
  hi(0, "Visual", { bg = color.selection_blue, ctermbg = 242 })
  ...
  hi(0, "@tag.tsx", { fg = color.html_tag_gold })
  hi(0, "@tag.javascript", { fg = color.html_tag_gold })
  ...
  -- HTML / CSS
  hi(0, "@tag.html", { fg = color.html_tag_gold })
  ...
  hi(0, "@tag.css", { fg = color.html_tag_gold })
  ...
  -- Doc comments (IntelliJ green for documentation comments)
  hi(0, "@comment.documentation", { fg = color.doc_comment_green, italic = true })
  hi(0, "@string.documentation", { fg = color.doc_comment_green, italic = true })

  -- Lua (vim-specific)
  hi(0, "@variable.builtin.lua", { fg = color.burnt_orange })
  hi(0, "@lsp.type.variable.lua", { fg = color.grey })

  -- Link vim builtins to treesitter groups for consistent coloring
