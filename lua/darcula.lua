...
M.configure_highlights = function(color)
  ...
  if M.config.opt.integrations.snacks then
    ...
    hi(0, "SnacksExplorerTitle", { bg = color.dark_charcoal_gray, fg = color.golden_yellow, bold = true })
    hi(0, "SnacksInputNormal", { bg = color.dark_charcoal_gray, fg = color.grey })
    hi(0, "SnacksInputBorder", { bg = color.dark_charcoal_gray, fg = color.dark_charcoal_gray })
    hi(0, "SnacksInputTitle", { bg = color.dark_charcoal_gray, fg = color.golden_yellow, bold = true })
    hi(0, "SnacksLayoutTitle", { bg = color.dark_charcoal_gray, fg = color.golden_yellow, bold = true })
    hi(0, "SnacksLayoutBorder", { bg = color.dark, fg = color.dark_charcoal_gray })
